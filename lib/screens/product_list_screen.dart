...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void _loadProducts() {
    _products = Product.getByCategory(widget.categoryId);
    if (_products.isEmpty) {
      // Nếu không có sản phẩm trong category, hiển thị tất cả
      _products = Product.demoProducts;
    }
  }
  ...
  void _sortProducts() {
    switch (_sortBy) {
      case 'newest':
        _products.sort((a, b) => b.isNew ? 1 : -1);
        break;
      case 'price_low':
